...
gulp.task('modernizr', function() {
    return gulp.src(['./js/_main.js'],['./css/main.min.css'])
        .pipe(modernizr({
            excludeTests: [''],
            options: ['setClasses'],
...
gulp.task('watch', function() {
    ...
    // Watch .js files
    gulp.watch('./js/_main.js', ['scripts', 'cssJsDevelopment']);
...
gulp.task('watchbuild', function() {
    ...
    // Watch .js files
    gulp.watch('./js/_main.js', ['scriptsmin', 'cssJsProduction']);
